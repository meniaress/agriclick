            ...
            <div class="navbar-nav mx-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="animal.html" class="dropdown-item"> Ajouter un animal </a>
                        <a href="consultation.html" class="dropdown-item">Créer une consultation</a>
                    </div>
                </div>
...
document.getElementById('consult').addEventListener('submit', function(event) {
    ...
    ['nomanimal', 'nomp', 'antmedicaux', 'diagnostic','reco'].forEach(function(id) {
    ...
    if (isValid) {
        alert('Form submitted successfully!');
        document.getElementById('consultForm').submit(); // Submit the form manually
    }
</script>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['photo']) && $_FILES['photo']['error'] == 0) {
      ...
      move_uploaded_file($photoTmpName, 'C:/xampp/htdocs/projet/' . $photoPath); 
    } else {
...
<div class="content">
    <div class="form-container">
        ...
        <form action="" method="POST" enctype="multipart/form-data" id="client-form">
            ...
            <img id="profile-pic" 
     src="<?php echo htmlspecialchars($client['photo'] ? '/projet/uploads/' . $client['photo'] : '/projet/uploads/default_profile.png'); ?>" >

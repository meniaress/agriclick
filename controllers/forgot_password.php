...
require 'C:/xampp/htdocs/projet 2/view/front office/PHPMailer/src/Exception.php';
require 'C:/xampp/htdocs/projet 2/view/front office/PHPMailer/src/PHPMailer.php';
require 'C:/xampp/htdocs/projet 2/view/front office/PHPMailer/src/SMTP.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        echo "<script>
            ...
            window.location.href = 'http://localhost/projet%202/view/front%20office/forgot_password.html';  
        </script>";
        exit();
    }
        ...
        try {
            ...
            $mail->Body = "
                ...
                <body>
                    ...
                    <a href='http://localhost/projet%202/view/front%20office/reset.php?email=" . urlencode($email) . "'>Réinitialiser mon mot de passe</a>

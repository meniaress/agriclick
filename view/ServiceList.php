...
<a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown">Partenariats</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">Liste de service</h1>
    ...
    <div class="container-fluid py-5 bg-light">
        <div class="container">
            ...
            <div class="container py-5">
                <input type="text" id="searchInput" class="form-control mb-4" placeholder="recherche pour services" aria-label="recherche pour services">
                <div class="row">
        <div class="col-md-6">
            <label for="minPrice" class="form-label">Minimum Prix:</label>
            <input type="number" id="minPrice" class="form-control" placeholder="Min Prix">
        </div>
        <div class="col-md-6">
            <label for="maxPrice" class="form-label">Maximum Prix:</label>
            <input type="number" id="maxPrice" class="form-control" placeholder="Max Prix">
        </div>
    </div>
            </div>

function validateForm(event) {
    ...
    if (!usernamePattern.test(username) || digitCount > 3) {
        usernameMessage.innerHTML = "Le nom d'utilisateur doit contenir entre 8 et 16 caractères, inclure des chiffres et des lettres, et ne pas avoir plus de 3 chiffres.";

...
include_once 'C:\xampp\htdocs\projet%202\controllers\config.php';
   ...
   <div class="admin-container">
        ...
        <div class="content">
            <div class="form-container">
                ...
                <form action="http://localhost/projet%202/controllers/update_client.php" method="POST" enctype="multipart/form-data" id="client-form">
   <!---                 

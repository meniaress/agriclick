...
<script>
    document.getElementById('returnHome').addEventListener('click', function(event) {
        ...
        switch (profession) {
            case 'Vétérinaire':
                window.location.href = "/projet/view/farmfresh-1.0.0/vet.html";
                break;
            case 'Mécanicien':
                window.location.href = "/projet/view/farmfresh-1.0.0/mecanicien.html";
                break;
            case 'Saisonnier':
                window.location.href = "/projet/view/farmfresh-1.0.0/saisonnier.html";
                break;
            case 'Agriculteur':
                window.location.href = "/projet/view/farmfresh-1.0.0/agriculteure.html";
                break;
            default:
                window.location.href = "/projet/view/farmfresh-1.0.0/index1.html";
                break;
        }
    });
</script>

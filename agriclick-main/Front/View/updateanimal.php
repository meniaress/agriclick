...
<body>
    ...
    $idd = $_GET['id_animal'];
    $animalList = $animalController->listAnimalssolo($idd);
    ?>
     <?php
                                   
                                        foreach ($animalList as $animazl) {
                                    ?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <form id="animalForm" action="updatecrude.php" method="POST" >
                    <div class="mb-3">
                            
                            <input hidden type="text" class="form-control" value="<?php echo $animazl['id_ani']; ?>" id="id_ani" name="id_ani" required>
                        </div>
                        <div class="mb-3">
                            <label for="nom_ani" class="form-label">Nom de l'animal</label>
                            <input type="text" class="form-control"value="<?php echo $animazl['nom_ani']; ?>" id="nom_ani" name="nom_ani" required>
                        </div>
                        <div class="mb-3">
                            <label for="espece" class="form-label">Espèce</label>
                            <input type="text" value="<?php echo $animazl['espece']; ?>" class="form-control" id="espece" name="espece" required>
                        </div>
                        <div class="mb-3">
                            <label for="genre" class="form-label">Genre</label>
                            <input type="text" class="form-control"value="<?php echo $animazl['genre']; ?>"  id="genre" name="genre" required>
                        </div>
                        <div class="mb-3">
                            <label for="race" class="form-label">Race</label>
                            <input type="text" class="form-control"value="<?php echo $animazl['race']; ?>"  id="race" name="race" required>
                        </div>
                        <div class="mb-3">
                            <label for="poid" class="form-label">Poids (kg)</label>
                            <input type="number" class="form-control"value="<?php echo $animazl['poid']; ?>"  id="poid" name="poid" required>
                        </div>
                        <div class="mb-3">
                            <label for="age" class="form-label">Âge (années)</label>
                            <input type="number" class="form-control" value="<?php echo $animazl['age']; ?>" id="age" name="age" required>
                        </div>
                        <div class="mb-3">
                            <label for="date_nais" class="form-label">Date de Naissance</label>
                            <input type="date" class="form-control" value="<?php echo $animazl['date_nais']; ?>" id="date_nais" name="date_nais" required>
                        </div>
